...
SITEURL = 'https://ctakes.apache.org'
SITEREPOSITORY = 'https://github.com/apache/ctakes-site/blob/main/content/'
...
#     asfreader (ASFReader) - reads GFM Markdown with embedded ezt ctakess uses metadata enhanced
